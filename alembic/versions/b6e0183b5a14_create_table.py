...
Revision ID: b6e0183b5a14
Revises: 
Create Date: 2024-02-28 00:18:06.069352
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('WAITING_FOR_CONFIRMATION', 'COMFIRMED', 'PARTIALLY_RECEIVED', 'RECEIVED', 'CANCELLED', 'COMPLETED', name='importstatus'), nullable=False),
    ...
    op.create_table('peomotion_belong_to_branch',
    sa.Column('id', postgresql.UUID(as_uuid=True), nullable=False),
    ...
    sa.Column('status', sa.Enum('ACTIVE', 'INACTIVE', 'PENDING', 'EMPTY', name='productstatus'), nullable=False),
    sa.Column('note', sa.String(length=255), nullable=True),
    ...
    sa.Column('start_date', sa.DateTime(), nullable=False),
    sa.Column('end_date', sa.DateTime(), nullable=False),
    sa.Column('status', sa.Enum('ACTIVE', 'INACTIVE', 'EMPTY', name='promotionstatus'), nullable=False),
...
def downgrade() -> None:
    ...
    op.drop_table('peomotion_belong_to_branch')
