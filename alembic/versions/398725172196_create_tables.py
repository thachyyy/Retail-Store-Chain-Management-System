...
Revision ID: 398725172196
Revises: 
Create Date: 2024-02-28 17:35:49.839484
...
def upgrade() -> None:
    ...
    sa.Column('belong_to_vendor', postgresql.UUID(as_uuid=True), nullable=False),
    sa.ForeignKeyConstraint(['belong_to_vendor'], ['vendor.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('start_date', sa.DateTime(), nullable=False),
    sa.Column('end_date', sa.DateTime(), nullable=False),
    sa.Column('status', sa.Enum('ACTIVE', 'INACTIVE', 'PENDING', 'EMPTY', name='status'), nullable=False),
    ...
    sa.Column('note', sa.String(), nullable=True),
    sa.Column('handle_by', postgresql.UUID(as_uuid=True), nullable=False),
    sa.Column('belong_to_customer', postgresql.UUID(as_uuid=True), nullable=False),
    sa.ForeignKeyConstraint(['belong_to_customer'], ['customer.id'], ),
    sa.ForeignKeyConstraint(['handle_by'], ['employee.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('belong_to_order', postgresql.UUID(as_uuid=True), nullable=False),
    sa.ForeignKeyConstraint(['belong_to_order'], ['purchase_order.id'], ),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('belong_to_vendor', postgresql.UUID(as_uuid=True), nullable=False),
    sa.Column('belong_to_contract', postgresql.UUID(as_uuid=True), nullable=False),
    sa.Column('belong_to_invoice', postgresql.UUID(as_uuid=True), nullable=True),
    sa.ForeignKeyConstraint(['belong_to_contract'], ['contract.id'], ),
    sa.ForeignKeyConstraint(['belong_to_invoice'], ['invoice_from_vendor.id'], ),
    sa.ForeignKeyConstraint(['belong_to_vendor'], ['vendor.id'], ),
    ...
    sa.Column('belong_to_branch', postgresql.UUID(as_uuid=True), nullable=False),
    sa.Column('belong_to_receipt', postgresql.UUID(as_uuid=True), nullable=False),
    sa.ForeignKeyConstraint(['belong_to_branch'], ['branch.id'], ),
    sa.ForeignKeyConstraint(['belong_to_receipt'], ['warehouse_receipt.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_table('product_of_warehouse_receipt',
    sa.Column('id', postgresql.UUID(as_uuid=True), nullable=False),
    sa.Column('product_id', postgresql.UUID(as_uuid=True), nullable=False),
    sa.Column('warehouse_receipt_id', postgresql.UUID(as_uuid=True), nullable=False),
    sa.Column('import_price', sa.Float(), nullable=False),
    sa.ForeignKeyConstraint(['product_id'], ['product.id'], ),
...
def downgrade() -> None:
    ...
    op.drop_table('invoice_for_customer')
    op.drop_table('purchase_order')
    op.drop_table('promotion')
    op.drop_table('invoice_from_vendor')
