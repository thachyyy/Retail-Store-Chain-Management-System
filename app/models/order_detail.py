...
class OrderDetail(Base):
    ...
    # proxies
    purchase_order_name = association_proxy(target_collection='purchase_order', attr='full_name')
    batch_name = association_proxy(target_collection='batch', attr='name_detail')
