...
class AppStatus(Enum):
    ...
    LOGIN_SUCCESSFULLY = status.HTTP_200_OK, 200, "LOGIN_SUCCESSFULLY"
    ...
    ERROR_PASSWORD_CONFIRM_INCORRECT_ERROR = status.HTTP_400_BAD_REQUEST, 400, 'PASSWORD_CONFIRM_INCORRECT_ERROR'
    ...
    ERROR_BRANCH_NOT_HAVE_EMPLOYEE = status.HTTP_404_NOT_FOUND, 404, 'BRANCH_NOT_HAVE_EMPLOYEE'
