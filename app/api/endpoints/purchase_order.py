...
async def update_purchase_order(
    ...
    msg, purchase_order_response = await purchase_order_service.update_purchase_order(purchase_order_id, purchase_order_update, current_user.tenant_id)
...
async def delete_purchase_order(
    ...
    msg, purchase_order_response = await purchase_order_service.delete_purchase_order(purchase_order_id, current_user.tenant_id)
